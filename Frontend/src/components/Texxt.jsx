...
export default function Texxt({ setPagesWithHistory, openMiniFor }) {
    ...
    return (
        <>
            ...
            <Row gutter={[12, 12]}>
                <Col span={24}>
                    <Button block type="primary" icon={<RiFontSize2 size={25} />} style={{ 
                        height: 50, 
                        fontSize: 20, 
                        fontWeight: "bold",
                        background: "#FF6B35",
                ...
                <Col span={24}>
                    <Button block icon={<FaHeading size={19} />} style={{ 
                        height: 45, 
                        fontSize: 16, 
                        fontWeight: 500,
                ...
                <Col span={24}>
                    <Button block icon={<RxHeading size={18} />} style={{ 
                        height: 40, 
                        fontSize: 14, 
                        fontWeight: 400,
                        border: "1px solid #e0e0e0",
                ...
                <Col span={24}>
                    <Button block icon={<GoHeading size={15} />} style={{ 
                        height: 35, 
                        fontSize: 12, 
                        fontWeight: 400,
                        border: "1px solid #e0e0e0",
