...
export default function Editor() {
    ...
    useEffect(() => {
        const handleKeyDown = (e) => {
            ...
            const isTextEditing = selectedEl?.type === 'text' && (e.key === 'Delete' || e.key === 'Backspace' || e.key === 'ArrowLeft' || e.key === 'ArrowRight' || e.key === 'ArrowUp' || e.key === 'ArrowDown' || e.key === 'Home' || e.key === 'End' || e.key === 'Enter' || (e.key.length === 1 && !e.ctrlKey && !e.metaKey));
            ...
            if (selectedUniqueId && !e.ctrlKey && !e.metaKey && selectedEl?.type !== 'text') {
                ...
                if (e.key === 'ArrowLeft') {
                    e.preventDefault();
                    setElement(selectedUniqueId, (el) => ({ ...el, x: (el.x || 0) - moveDistance }));
                    moved = true;
                }
                if (e.key === 'ArrowRight') {
                    e.preventDefault();
                ...
                if (e.key === 'ArrowUp') {
                    e.preventDefault();
                    setElement(selectedUniqueId, (el) => ({ ...el, y: (el.y || 0) - moveDistance }));
                    moved = true;
                }
                if (e.key === 'ArrowDown') {
                    e.preventDefault();
        ...
        <>
            ...
            >
                <PageContainer
                    content={
                        <>
                            <Flex align="center" justify="start" gap={12} wrap style={{ 
                                background: "white", 
                                padding: "12px 20px", 
                                borderRadius: 8,
                                ...
                                <div ref={undoRedoRef}>
                                    <UndoRedo pushHistory={pushHistory} undoRedoRef={undoRedoFunctionsRef} />
                                </div>
