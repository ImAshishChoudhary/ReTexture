...
const banners = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        width: 300,
        height: 400,
        // src: banner7, // Image not available
      },
      {
        id: `b${Date.now()}-desc`,
        type: "text",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        width: 500,
        height: 500,
        // src: banner9, // Image not available
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        width: 500,
        height: 500,
        // src: banner8, // Image not available
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        width: 800,
        height: 400,
        // src: banner10, // Image not available
      },
      {
        id: `b${Date.now()}-title`,
        type: "text",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        width: 900,
        height: 500,
        // src: banner11, // Image not available
      },
      {
...
export default function BannerList({ setPagesWithHistory }) {
  ...
  const applyTemplate = (template) => {
    ...
    setPagesWithHistory((prev) => {
      ...
      const children = (template?.children || []).map((el) => ({
        ...el,
        id: `${el?.id}-${Date.now()}`,
      }));
      cp[activeIndex] = {
